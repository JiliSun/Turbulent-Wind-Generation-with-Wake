function [velocity, twrVelocity, y, z, zTwr, nz, ny, dz, dy, dt, zHub, z1, Vslope, Voffset] = readTSgrid(ADFileName,fileFmt)
%[velocity, twrVelocity, y, z, zTwr, nz, ny, dz, dy, dt, zHub, z1] = readTSgrid(ADFileName,fileFmt)
...
%
% Output:
%  velocity      - 4-D array: time, velocity component, iy, iz 
